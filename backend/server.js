...
let frontendAppUrl = process.env.FRONTEND_URL;
if (process.env.NODE_ENV === "development") frontendAppUrl = process.env.FRONTEND_URL_DEV;
...
app.use(cors({ origin: frontendAppUrl, credentials: true }));
